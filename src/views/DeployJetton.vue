  ...
  >
    <div class="grid is-gap-1">
      ...
      <div class="cell">
        <div class="">
          <JettonExample
            jetton-name="Example name"
            jetton-description="An example of jetton description"
            :jetton-max-supply="1337"
            jetton-symbol="SMBL"
          />
        </div>
      </div>
      ...
      <div class="cell is-col-span-4-desktop">
        <div class="box is-shadowless">
          <CardItem
            emoji="🤔"
            :title="$t('message.NewJettonCards.Information.Title')"
      ...
      <div class="cell is-col-span-1-desktop">
        <div class="box is-shadowless has-background-danger-light">
          <CardItem
            emoji="⚠️"
            :title="$t('message.NewJettonCards.WorkInProgress.Title')"
      ...
      <div class="cell is-col-span-1-desktop">
        <div class="box is-shadowless has-background-light">
          <CardItem
            emoji="🛠️"
            :title="$t('message.NewJettonCards.Managable.Title')"
      ...
      <div class="cell is-col-span-1-desktop">
        <div class="box is-shadowless has-background-link-light">
          <CardItem
            emoji="👨‍💻"
            :title="$t('message.NewJettonCards.OpenSource.Title')"
      ...
      <div class="cell is-col-span-1-desktop">
        <div class="box is-shadowless has-background-info-light">
          <CardItem
            emoji="⛓️"
            :title="$t('message.NewJettonCards.Decentralized.Title')"
